                        ...
                        <div class="kt-portlet__head form-header">
                         ...
                         <div class="kt-portlet__body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-3">
                                        {{Form::select('menu_for', [\App\Models\Menu::ADMIN_MENU => \App\Models\Menu::ADMIN_MENU,\App\Models\Menu::CLIENT_MENU => \App\Models\Menu::CLIENT_MENU,\App\Models\Menu::USER_MENU => \App\Models\Menu::USER_MENU],'', ['class' => 'form-control'])}}
